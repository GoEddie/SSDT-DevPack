    ...
    public class TagStore
    {
        ...
        private List<GlyphDefinition> GetGlyphDefinitions(List<TSqlStatement> statements, string script)
        {
            ...
            foreach (var statement in statements)
            {
                ...
                definition = AddInequalityRewrites(fragment, statement, definition, queriesInStatement);
        ...
        private GlyphDefinition AddInequalityRewrites(string fragment, TSqlStatement statement, GlyphDefinition definition, List<QuerySpecification> queries)
        {
